...
In the next chapter, we will start by installing mBlock on thevcomputer. Then, we will continue by taking a lengthily look at Scratch: the graphical programming language. Soon later, wevwill upload our first program to the mBot and learn how to control the motors.
