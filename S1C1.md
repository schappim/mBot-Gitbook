...
Question 1.1.1 : What is the name of the component that controls the mBot?
...
Question 1.1.2: What type of module can you connect to a port marked "M1" or "M2"?
...
\[Image 1.1.4: The mBot following a black line on the floor\]
...
\[Image 1.1.6: Both line sensors are over white - LEDs are lit\]

In Image 1.1.6, the line module is over the white part of the paper. You can see that both module indicator LEDs are lit. The mBot knows that it is outside the line. We can program it so that it tries to find the line.

![](/assets/both on black.JPG)

\[Image 1.1.7: Both line sensors are over black - LEDs are not lit\]

In Image 1.1.7, the line module is over the black part of the paper. You can see that both module indicator LEDs are not lit. The mBot knows that it is inside the line. We can program it so that it continues to travel on the line.

![](/assets/one on white 2.JPG)

\[Image 1.1.8: One line sensors is over white, and one is over black\]

In Image 1.1.8, the module's first sensor is over the black line while the second sensor is outside the line. Notice that indicator LED 2 is lit, while LED 1 is not lit. This tells the mBot that it is about to lose the line. To keep the mBot on the line, we can program it so that when this condition appears, the mBot takes a slight turn to the left, so that both sensors are over the black line.

You will learn how to do all this later in this book. For now, let's have a look at the rest of the modules.

---

Question 1.1.3: How many sensors are included in the line follower module?
...
Question 1.1.4: Which of the mBot ports can you connect the line follower module?
...
\[Image 1.1.9: The ultrasonic distance module contains an ultrasonic transmitter and receiver\]
...
Question 1.1.5: What are the two round, silver devices that are protruding from the ultrasonic distance module?
