...
\[Image 9.3: Additional controls on the Design tab\]
...
\[Image 9.5: The colour wheel\]

Next, you can try the distance sensor gauge. Put your hand, or some other object, like a book, in front of the sensor and slowly move it closer to the sensor and you should be able to see the ultrasonic reading, in the app, changing \(see Image 9.6\).

![](/assets/Mbot - 0080 - Ipad 1 - demo of Makeblock mblockly mblock.CONSTANT-00-06-43-682.png)

\[Image 9.6: The ultrasonic distance indicator shows distance in centimetres. The brightness chart show light intensity from 0 \(dark\) to 1023 \(very bright\)\]

Next, let's play with the light sensor. Use your palm to cover the top of the mBot, where the sensor is located. You should see that the corresponding reading in the app increases \(see example in Image 9.7\).
...
\[Image 9.7: Covering the light sensor with the hand\]
...
\[Image 9.8: With the joystick you can control the movement of your mBot\]

Next we can try and control the mBot. The control lever is very much like a joystick \(see image 9.8\). Try all different directions with it and you should see the mBot react accordingly.
...
\[Image 9.9: While in Design mode, tapping on a button reveals the options menu. Tap on Code to see the code behind a button\]
...
\[Image 9.11: Drag the "play not on C5" block and attach it to the "when button released" block\]

![](/assets/Mbot - 0080 - Ipad 1 - demo of Makeblock mblockly mblock.CONSTANT-00-12-56-169.png)

\[Image 9.12: The final set of instructions for the Sprint button\]
...
\[Image 9.14: The Draw and Run canvas\]
...
**Question 9.1: What does the ultrasonic reading mean?**
...
**Question 9.2: Which instruction can stop the moving of the wheels?**
